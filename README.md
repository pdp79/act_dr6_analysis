...
The priors used in our analysis are a collection of small ``Python`` dictionaries generated by the [``priors.py``](priors.py) script. [``__init__.py``](__init__.py) should generate them the first time you import the ``act_dr6_analysis`` module. See [line 30](https://github.com/pdp79/act_dr6_analysis/blob/0e12e98e3db30ca232a6ade2caacd96559618306/__init__.py#L30). If, for some reason, line 30 didn't go through, you can separately run ``priors.py`` to generate the files.
